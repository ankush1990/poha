// JavaScript Document
var globalip = "http://pohaindorinamkeen.com/webservice";
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
   .state('signin', {
	...
	.state('eventmenu.product_detail', {
      url: "/product_detail",
      views: {
        'menuContent' :{
	...
	.state('eventmenu.lastorder', {
      url: "/lastorder",
      views: {
        'menuContent' :{
          templateUrl: "templates/lastorder.html"
        }
      }
    })
